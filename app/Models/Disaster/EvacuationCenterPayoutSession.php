...
class EvacuationCenterPayoutSession extends Model {
    use HasUuid;
    protected $fillable=['uuid','evacuation_center_id','disaster_id','payout_date','start_time','end_time','payout_area','assigned_officer_id','assistance_type','default_amount','provider','status','notes','created_by'];
    protected function casts(): array { return ['payout_date'=>'date','default_amount'=>'decimal:2']; }
